...
(function(root, factory) {
  ...
  var supportsClassName = !0;
  var showRts = !0;
  var customCallbackFunction = null;
  var showInteractionLinks = !0;
  var showImages = !1;
  var targetBlank = !0;
  var lang = 'en';
  var permalinks = !0;
  ...
  var twitterFetcher = {
    fetch: function(config) {
      ...
      if (config.showRetweet === undefined) {
        config.showRetweet = !0
      }
      if (config.customCallback === undefined) {
        config.customCallback = null
      }
      if (config.showInteraction === undefined) {
        config.showInteraction = !0
      }
      if (config.showImages === undefined) {
        config.showImages = !1
      }
      if (config.linksInNewWindow === undefined) {
        config.linksInNewWindow = !0
      }
      if (config.showPermalinks === undefined) {
        config.showPermalinks = !0
      }
      ...
      if (dataOnly) {
        ...
        while (n < x) {
          ...
          if (parseLinks) {
            ...
            if (printTime) {
              if (permalinks) {
                op += '<p class="timePosted"><a href="' + permalinksURL[n] + '">' + times[n].getAttribute('aria-label') + ' | Les Mer</a></p>'
              } else {
          ...
          if (showInteractionLinks) {
            op += '<div style="position:absolute;bottom:-1em;"><a href="https://twitter.com/intent/' + 'tweet?in_reply_to=' + tids[n] + '" class="btn btn-info" style="padding:0.6rem 0.9rem !important;margin-left:0.1em; margin-right:0.1em;"' + (targetBlank ? ' target="_blank">' : '>') + '<span class="glyphicon glyphicon-comment" aria-hidden="true"></span></a><a href="https://twitter.com/intent/retweet?' + 'tweet_id=' + tids[n] + '" class="btn btn-info" style="padding:0.6rem 0.9rem!important;margin-left:0.1em; margin-right:0.1em;"' + (targetBlank ? ' target="_blank">' : '>') + '<span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span></a>' + '<a href="https://twitter.com/intent/favorite?tweet_id=' + tids[n] + '" class="btn btn-info" style="padding:0.6rem 0.9rem !important;margin-left:0.1em; margin-right:0.1em;"' + (targetBlank ? ' target="_blank">' : '>') + '<span class="glyphicon glyphicon-heart" aria-hidden="true"></span></a></div>'
          }
...
function handleTweets(tweets) {
    ...
    var html = '';
    while(n < x) {
      html += '<div class="animated wow fadeInUp card" data-wow-delay="0.3s>' + tweets[n] + '</div>';
      n++;
    }
    html += '';
    element.innerHTML = html;
